        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.ad.index', $user->id) }}"
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <div class="widget-two box--shadow2 b-radius--5 bg--white">
                            <div class="widget-two__icon b-radius--5">
                                <img src="{{ getImage(getFilePath('crypto').'/'. $wallet->crypto->image, getFileSize('crypto')) }}" alt="image">
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-text code">{{ __(gs('cur_text')) }}</div>
                            </div>
                        </div>
                        <div class="form-group">
